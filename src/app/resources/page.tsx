            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {items.map((r) => (
                <a
                  ...
                  className="group flex flex-col gap-2 border border-border bg-surface p-5 transition-colors hover:border-hazard-dim"
                >
                  <div
                  ...
                  <h3 className="font-semibold text-foreground group-hover:text-hazard">
                    {r.title}
                  </h3>
